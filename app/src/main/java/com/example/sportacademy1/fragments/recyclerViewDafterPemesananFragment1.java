...
import com.example.sportacademy1.Adapter.AdapterDataDaftarPemesananLapangan1;
...
public class recyclerViewDafterPemesananFragment1 extends Fragment {
    ...
    public recyclerViewDafterPemesananFragment1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recycler_view_dafter_pemesanan_1, container, false);
    ...
    public void retrieveDataPembayaran(){
        ...
        Call<Pembayaran> pembayaranCall = apiInterface.PembayaranRead1(idUser);
        pembayaranCall.enqueue(new Callback<Pembayaran>() {
            ...
            public void onResponse(Call<Pembayaran> call, Response<Pembayaran> response) {
                if (response.body()!=null && response.isSuccessful() && response.body().isStatus()){
                    ...
                    adDataPembayaran = new AdapterDataDaftarPemesananLapangan1(getActivity(),pembayaranDataList);
